...
class ModelTrainer:
    def __init__(self, model_trainer_config:ModelTrainerConfig, data_transformation_artifact:DataTransformationArtifact):
        try:
            ...
            self.model_trainer_config.feature_names=['Distance_km', 'Courier_Experience_yrs', 'Vehicle_Type_Pickup Truck', 'Vehicle_Type_Scooter', 'Weather_Foggy', 'Weather_Rainy', 'Weather_Snowy', 'Weather_Windy', 'Time_of_Day_Evening', 'Time_of_Day_Morning', 'Time_of_Day_Night', 'Traffic_Level_Low', 'Traffic_Level_Medium']
